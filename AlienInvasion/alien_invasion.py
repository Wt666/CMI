...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        self.sb = Scoreboard(self) # Create an instance to store game statistics, and create a scoreboard
        self.ship = Ship(self)
    ...
    def _create_fleet(self):
        ...
        available_space_x = self.settings.screen_width - (2 * alien_width) # Determining How Many Aliens Fit in a Row
